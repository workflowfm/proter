...
/**
  ...
  * 
  * Provides various functions to set simulation parameters and compile them in
  * a [[Simulation.SimState]].
  * 
  * Parameters include resources, cases/arrivals, and start and ending times.
  * 
  * @note Ordering of method calls matters, especially when using [[withStartingTime]].
  * 
  * @param A name to identify the scenario.
  * @param The current simulation state update corresponding to the parameters provided so far.
  */
final case class Scenario[F[_] : Monad](name: String, state: Simulation.SimState[F])
  ...
  /**
    ...
    * 
    * @param s The `SimState` to compose.
  ...
  /**
    ...
    * 
    * The case will be scheduled to start in the '''current''' start time
    * of the scenario. 
    * 
    ...
    * @param n A unique name for the case.
  ...
  /**
    ...
    * @tparam T The type of the object used for the simulation case.
    * @param n A unique name for the case.
    * @param time The timestamp when the case should start.
    * @param t The object to use for the simulation case.
    * @return The updated scenario.
    */
  ...
  /**
    ...
    * 
    * The cases will be scheduled to start in the '''current''' start time
    * of the scenario. 
    * 
  ...
  /**
    * Adds a collection of [[Case]]s, each with a specified starting time, to the simulation scenario.
    * 
  ...
  /**
    ...
    * 
    * The first case will be scheduled to arrive in the '''current''' start time
    * of the scenario. 
    * 
    * Manipulating the scenario start time ''after'' adding the cases may have unintended effects,
    * such as having a case start time in the past. 
    * 
    * @tparam T The type of the object used for the simulation case.
    * @param n A unique name for the cases.
    * @param t The object to use for the simulation case.
    * @param rate The probability ditribution determining the duration until the
    *             next arrival.
    * @param limit The maximum number of cases to generate.
    * @return The updated scenario.
    */
  def withArrival[T](
      n: String,
  ...
  /**
    ...
    * @tparam T The type of the object used for the simulation case.
    * @param n A unique name for the cases.
    * @param time The timestamp when the first case should arrive.
    * @param t The object to use for the simulation case.
    * @param rate The probability ditribution determining the duration until the
    *             next arrival.
    * @param limit The maximum number of cases to generate.
  ...
  /**
    ...
    * 
    * Calling this method multiple times will result in the earliest timestamp becoming the
    * time limit.
    * 
  ...
  /**
    ...
    * 
    * This will be the first timestamp in the simulation. Cases with no specified 
    * start time will start at the time set here.
    * 
    ...
    * 
    * @param t The timestamp to use as the start time.
    * @return The updated scenario.
    */
...
object Scenario extends StateOps {
  /**
    ...
    * 
    * @param name The name to use for the scenario.
  ...
  /**
    ...
    * 
    * Using this as a constructor is preferred as it reduces the chance of
    * misusing `withStartingTime`.
    * 
    * @param name The name to use for the scenario.
    * @param start The timestamp to use as the start time.
    * @return An empty scenario. 
    */
