...
/**
  ...
  * The timestamp parameter does not really matter here.
  *
  * @param source
  */
...
/**
  * A [[Task]] was attached to a [[TaskResource]] as it started.
  *
  * @param source
  * @param time
  * @param task The [[Task]] that was attached.
...
/**
  * A [[Task]] was detached from a [[TaskResource]] as it finished.
  *
  * @param source
  * @param time
  * @param task The [[Task]] that was detached.
  * @param resource The involved [[TaskResource]].
  */
