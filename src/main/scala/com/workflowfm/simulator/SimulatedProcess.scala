...
/**
  * Behaviour of a process that interacts with a [[SimulationActor]] to simulate [[Task]]s
  * through [[TaskGenerator]]s.
  *
  * This is useful when the simulation is distributed in multiple actors.
  * A [[SimulatedProcess]] can live in a different actor than the [[SimulationActor]]
...
trait SimulatedProcess {
  ...
  /**
    * A reference to the [[SimulationActor]] of the corresponding simulation.
    */
  ...
  /**
    ...
    *
    * This method sends a [[TaskGenerator]] to the [[SimulationActor]].
    ...
    *
    * @note Uses  Akka `ask` pattern to receive a response from the [[SimulationActor]]
  ...
  /**
    ...
    * is completed in the simulation.
    *
    * @note Uses the Akka `ask` pattern to receive a response from the [[SimulationActor]]
    *       when the [[Task]] completes. This blocks other interactions the actor of the
    *       [[SimulatedProcess]] can perform from now until the [[Task]] completes.
    *
